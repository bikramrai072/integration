package com.example.bikram.login;
...
public class LoginService  extends IntentService {
    ...
    private ContactsContract.Profile init(SocialMediaProvider provider) throws AuthenticatorException {
        //Superclass reference variable = subclass object
        ContactsContract.Profile profile = null;   // polymorphism
        switch (provider) {
            case FACEBOOK:
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) try {
            ...
            ContactsContract.Profile profile = init(provider);
    ...
    private UserAccount init(ContactsContract.Profile profile) {
